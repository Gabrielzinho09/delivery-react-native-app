...
export const DeliveryOrderMapScreen = ({navigation, route}: Props) => {
    ...
    const { messagePermissions, position, responseMessage, deliverySocket, mapRef, origin, destination, stopForegroundUpdate, updateToDeliveredOrder } = useViewModel(order);
